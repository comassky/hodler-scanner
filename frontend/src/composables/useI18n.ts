...
const messages: Record<LocaleId, any> = {
  en: {
    ...
    reset: {
      title: 'Reset data',
      subtitle: 'Pick exactly which data to permanently clear.',
      caches: 'Cached data', cachesDesc: 'In-memory analyses, charts, fundamentals & news',
      backtests: 'Stored backtests', backtestsDesc: 'Per-ticker historical score cache',
      watchlist: 'Watchlist', watchlistDesc: 'Your followed tickers',
      portfolio: 'Portfolio', portfolioDesc: 'Your saved positions',
      tickers: 'Ticker dictionary', tickersDesc: 'Name / ISIN search cache — slow to rebuild',
      userData: 'your data',
      irreversible: 'This action cannot be undone.',
      none: 'Select at least one type.',
      confirm: 'Clear selected', cancel: 'Cancel',
    ...
    app: {
      ...
      news: 'News', newsEmpty: 'No recent news.',
      newsUnavailable: 'News could not be loaded.',
      fundamentalsUnavailable: 'Fundamentals could not be loaded.',
    ...
    timing: {
      title: 'Is now a good time to buy & hold?',
      loading: 'Assessing the current entry timing…',
      historyPct: 'Better than {pct}% of its ~10-yr history',
      edge: 'Edge vs baseline: {edge} over {h}',
      unreliableNote: 'The score has shown no reliable edge on this ticker — treat the timing with caution.',
      level_excellent: 'Rare, excellent entry',
      level_good: 'Very good moment',
      level_fair: 'Decent moment, nothing special',
      level_poor: 'Not a great entry point',
      level_unreliable: 'Timing not reliable here',
      desc_excellent: 'The score sits at one of its highest levels of the last ~10 years and, historically, this zone clearly beat buying at a random time.',
      desc_good: 'The score is high versus this stock\'s own history, and this zone has historically beaten buying at a random time.',
      desc_fair: 'The score is around its historical average: an acceptable entry, but not one of the best moments for this stock.',
      desc_poor: 'The score is low versus this stock\'s history: historically, waiting for a deeper pullback paid better.',
      desc_unreliable: 'On this stock, high scores did not reliably beat buying at a random time — the timing signal can\'t be trusted here.',
    },
    info: {
      backtest: {
        title: 'Score backtest',
  ...
  fr: {
    ...
    reset: {
      ...
      subtitle: 'Choisissez précisément les données à supprimer définitivement.',
      caches: 'Données en cache', cachesDesc: 'Analyses, graphiques, fondamentaux & actualités en mémoire',
      backtests: 'Backtests stockés', backtestsDesc: 'Cache des scores historiques par titre',
      watchlist: 'Watchlist', watchlistDesc: 'Vos tickers suivis',
      portfolio: 'Portefeuille', portfolioDesc: 'Vos positions enregistrées',
      tickers: 'Dictionnaire de tickers', tickersDesc: 'Cache de recherche nom / ISIN — long à reconstruire',
      userData: 'vos données',
      irreversible: 'Cette action est irréversible.',
      none: 'Sélectionnez au moins un type.',
      confirm: 'Supprimer la sélection', cancel: 'Annuler',
      error: 'La réinitialisation a échoué. Réessayez.',
    },
    search: {
    ...
    app: {
      ...
      news: 'Actualités', newsEmpty: 'Aucune actualité récente.',
    ...
    timing: {
      title: 'Est-ce le bon moment pour acheter et garder ?',
      loading: 'Évaluation du timing d’entrée…',
      historyPct: 'Mieux que {pct}% de son historique ~10 ans',
      edge: 'Écart vs référence : {edge} sur {h}',
      unreliableNote: 'Le score n’a pas montré d’avantage fiable sur ce titre — timing à prendre avec prudence.',
      level_excellent: 'Moment rare, excellent',
      level_good: 'Très bon moment',
      level_fair: 'Moment correct, sans plus',
      level_poor: 'Pas un bon point d’entrée',
      level_unreliable: 'Timing peu fiable ici',
      desc_excellent: 'Le score est à l’un de ses plus hauts niveaux des ~10 dernières années et, historiquement, cette zone a nettement battu un achat à un moment au hasard.',
      desc_good: 'Le score est élevé par rapport à l’historique du titre, et cette zone a historiquement battu un achat au hasard.',
      desc_fair: 'Le score est proche de sa moyenne historique : une entrée acceptable, mais pas l’un des meilleurs moments pour ce titre.',
      desc_poor: 'Le score est bas par rapport à l’historique du titre : historiquement, attendre un repli plus marqué a mieux payé.',
      desc_unreliable: 'Sur ce titre, les scores élevés n’ont pas battu de façon fiable un achat au hasard — le signal de timing n’est pas fiable ici.',
    },
    info: {
      backtest: {
        title: 'Backtest du score',
